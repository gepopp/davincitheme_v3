...
get_template_part( 'headers', 'banderole' ); ?>
    ...
    <div class="bg-darkblue border-t border-golden">
        <div class="container mx-auto">
            <div class="grid grid-cols-1 sm:grid-cols-3 text-white py-3">
                <a href="" class="flex justify-between w-1/2 items-center py-3">
                    <div class="bg-lightblue rounded-full p-2 mr-3 inline-block">
